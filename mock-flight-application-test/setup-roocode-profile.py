...
def update_json_values(settings_data, env_vars, model_name):
    ...
    if "providerProfiles" in settings_data:
        if "apiConfigs" in settings_data["providerProfiles"]:
            # Update bharath-profile configuration
            if "bharath-profile" in settings_data["providerProfiles"]["apiConfigs"]:
                profile = settings_data["providerProfiles"]["apiConfigs"]["bharath-profile"]
